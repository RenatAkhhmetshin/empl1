...
public class EmplTestContainer extends TestContainer {

    public EmplTestContainer() {
        super();
    ...
    public static class Common extends EmplTestContainer {

        public static final EmplTestContainer.Common INSTANCE = new EmplTestContainer.Common();
